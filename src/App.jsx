...
export default function App() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-[#070A0F] text-slate-200 font-mono flex flex-col">
      <TopHeader anomalies={anomalies} stats={stats} />
      <div className="flex flex-1 overflow-hidden">
        <Sidebar activeTab={activeTab} setActiveTab={setActiveTab} stats={stats} />
        <main className="flex-1 overflow-hidden">
          {activeTab === 'map' && <MapView anomalies={anomalies} selectedTarget={selectedTarget} setSelectedTarget={setSelectedTarget} stats={stats} />}
